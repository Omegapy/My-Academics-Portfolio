/*
    ...
    Program Description: 
    This is an an Alpha version of the Home Inventory Manager program.
 ...
 * The class has getters and setters' methods to accesses and manipulate the Home objects' data
 * 
 ...
 */
public class Home {
    private Integer id = null;  // Declare and initialize the Integer object to null 
    ...
    public Integer getId() throws NullPointerException {
        try {
            ...
            System.out.println("The ID was found!");  // success message
            return id;
        } catch (Exception e) {
     ...
     * outputs:
     * Home{id=1, squareFeet=1500, address='123 Main St', city='Anytown', 
     *      state='CA', zipCode=12345, modelName='Model A', saleStatus='Available'}
     *      
