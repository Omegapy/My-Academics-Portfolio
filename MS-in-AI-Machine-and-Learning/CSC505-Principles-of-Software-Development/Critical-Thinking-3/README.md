...
Part of Step 3: Python Script to Describe Prototype.  
...
- Apple's "Human Interface Guidelines" tutorial (Apple, n.d.) was used as a reference on how to design UI layout for mobile apps. 
- The "Mobile user experience: Limitations and strengths" (Budiu, 2015) was used as a reference on how to create UI prototypes that follow standard mobile usability guidelines.
- The "UML Component Diagrams" tutorial (UML Diagrams, n.d.) was used as a reference on how to properly draw a UML component diagram.
- The IBM Carbone (IBM, n.d.), an open source design system project, more specifically the "Partner" section, was used as a reference on how to design the "empty state" of the shopping list (when no items are added yet) and the search functionality of the app.
- The course textbook, more specifically "Chapter 4: Recommended Process Model" (Pressman & Maxim, 2020), was used as a reference on how to construct and evaluate a prototype.

---

**References**: 

Apple Developer. (n.d.). *Human Interface Guidelines*. Apple. https://developer.apple.com/design/human-interface-guidelines


Budiu, R. (2015, January 4). *Mobile user experience: Limitations and strengths*. Nielsen Norman Group. https://www.nngroup.com/articles/mobile-ux/


IBM. (n.d.). Mobile patterns: Search and empty states. IBM. https://carbondesignsystem.com/patterns/overview/


Pressman, R. S., & Maxim, B. R. (2020). Chapter 4: Recommended Process Model. Software engineering: A practitioner’s approach (9th ed.). McGrawHill. ISBN: 9781260423297
...
- shopping_list_prototype.py - the Python script summarizing the UI flow
- script_running_screenshot.png - contains a screenshot of the program running successfully
- Mobile App component diagram.png - the architectural design diagram (UI, Logic, Data layers)
- Mobile Shopping APP UI Prototype.png - sketches of the paper prototype screens
...
<a href="https://www.alexomegapy.com" target="_blank"><img width="25" height="25" src="https://github.com/user-attachments/assets/a8e0ea66-5d8f-43b3-8fff-2c3d74d57f53"></a>    [![Medium](https://img.shields.io/badge/Medium-12100E?style=for-the-badge&logo=medium&logoColor=whit)](https://medium.com/@alex.omegapy)    [![Facebook](https://img.shields.io/badge/Facebook-%231877F2.svg?logo=Facebook&logoColor=white)](https://www.facebook.com/profile.php?id=100089638857137)    [![LinkedIn](https://img.shields.io/badge/LinkedIn-%230077B5.svg?logo=linkedin&logoColor=white)](https://linkedin.com/in/alex-ricciardi)    <a href="https://www.threads.net/@alexomegapy?hl=en" target="_blank"><img width="53" height="20" src="https://github.com/user-attachments/assets/58c9e833-4501-42e4-b4fe-39ffafba99b2"></a>    [![X](https://img.shields.io/badge/X-black.svg?logo=X&logoColor=white)](https://x.com/AlexOmegapy)    [![YouTube](https://img.shields.io/badge/YouTube-%23FF0000.svg?logo=YouTube&logoColor=white)](https://www.youtube.com/channel/UC4rMaQ7sqywMZkfS1xGh2AA) 
