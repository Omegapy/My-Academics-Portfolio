...
#
# --- Usage / Integration ---
# - Imported by ``overview_page.py`` to keep tab rendering consistent.
...
# Analysis imports
from tree_map_module.analysis.report_generator import (
    CHART_FILENAMES,
...
def render_header() -> None:
    ...
    Logic:
        This helper draws the shared page title used across the app.
        1. Render the module title.
        2. Separate the header from later content with a divider.
    """
    st.title("Tree Map")
    st.divider()
# --------------------------------------------------------------- 
