# Critical Thinking Module 4 - First-Fit Memory Allocation
Project: CTA4 - First-Fit Memory Allocation
...
- CTA4 - First-Fit Memory Allocation.pdf contains the APA essay and screenshots of the terminal commands with results.
- CTA4 - First-Fit Memory Allocation.py contains the Python program that simulates the First-Fit Algorithm.
- CTA4 - first_fit_results.txt contains terminal outputs of the program.
- CTA4 - first_fit_results.csv a CSV file of the terminal outputs.
